...
namespace DAL
{
    ...
    public partial class ABBConnectEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> AddUserSavedFilter(Nullable<int> userId, string filterName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, string location, string type)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("AddUserSavedFilter", userIdParameter, filterNameParameter, startDateParameter, endDateParameter, locationParameter, typeParameter);
        }
