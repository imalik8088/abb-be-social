...
namespace BLL
{
    public class SensorFeed: Feed
    {
        ...
        public SensorFeed(GetAllSensorFeeds_Result res, List<Comment> listCom, List<Human> listTag)
        {
            base.Category = new Category();
            base.Comments = new List<Comment>();
            base.Tags = new List<Human>();
        ...
        public SensorFeed(GetAllSensorFeedsByFilter_Result res, List<Comment> listCom, List<Human> listTag)
        {
            base.Category = new Category();
            base.Comments = new List<Comment>();
            base.Tags = new List<Human>();
